...
// DESIGN-024-BOOTSTRAP-STABILITY-FINAL: ErrorBoundary desabilitado durante bootstrap (INIT/LOADING)
// REACT-RENDER-CRASH-FIX-001: BrowserRouter movido para FORA do BootstrapGuard
